...
export function PublicStatePanel({ game }: PublicStatePanelProps) {
  const visibleTracks = Object.entries(game.publicState.visibleTracks);

  return (
    <section className="panel">
      <div className="panel__header">
        <h2>Public State</h2>
        <span className="pill">World tension {game.publicState.worldTension}%</span>
      </div>
      ...
      <div className="inline-meta">
        {game.publicState.publicFlags.map((flag) => (
