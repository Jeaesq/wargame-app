...
- lightweight quality signals such as topical specificity and low-filler responses
...
- lightweight plausibility signals such as topical grounding, escalation labeling, and low-filler narration
...
The runner currently uses the local mock advisor and mock turn providers so it stays offline and fast. It prints:
